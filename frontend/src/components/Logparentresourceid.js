...
const Logparentresourceid = () => {
  ...
  const handlePerformQuery = async () => {
    try {
      ...
      const response = await fetch(`/logs/searchbyparentResourceId?parentResourceId=${parentResourceId}`,{
        method: 'GET'
      });
  ...
  return (
    <div>
      <Title style={{textAlign:"center"}}>Retrieve logs related to a specific Parent Resource ID</Title>
...
export default Logparentresourceid;
